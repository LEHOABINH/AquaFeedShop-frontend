...
const TrTableTasksReAssign = ({ taskId, taskName, description, startDate, endDate, status, progress, taskAssigns}) => {
...
TrTableTasksReAssign.propTypes = {
