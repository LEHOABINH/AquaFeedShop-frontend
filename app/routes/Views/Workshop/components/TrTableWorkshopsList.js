...
const TrTableWorkshopsList = ({ workshop, onEdit, onDelete }) => {
    const { role } = useAuth();
        ...
        <Card className="mb-3 shadow-sm">
            <CardBody>
                ...
                <div className="d-flex justify-content-between align-items-center">
                    <span 
                        className={`badge ${
                            workshop.status === 'Completed' ? 'badge-danger' : 
                            workshop.status === 'Not_Started' ? 'badge-primary' : 
                            'badge-secondary'
                        }`}
                    >
                        {workshop.status}
...
TrTableWorkshopsList.propTypes = {
    workshop: PropTypes.object.isRequired,
    onEdit: PropTypes.func.isRequired,
    onDelete: PropTypes.func.isRequired,
};

export { TrTableWorkshopsList };
