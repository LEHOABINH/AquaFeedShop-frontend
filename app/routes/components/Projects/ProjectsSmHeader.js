        ...
        <div className="d-flex flex-column flex-md-row mb-3 mb-md-0">
            ...
            <ButtonToolbar>
                <ButtonGroup className="mr-auto mr-md-2">
                    ...
                    {
                        props.btnShowKanban && props.linkKanban && (
                            <React.Fragment>
                ...
                </ButtonGroup>
                {
                    props.onAddNewClick && (
                        <ButtonGroup>
                            <Button color="primary" className="align-self-center" id="tooltipAddNew" onClick={props.onAddNewClick}>
...
ProjectsSmHeader.propTypes = {
    ...
    linkGrid: PropTypes.string,
    btnShowKanban: PropTypes.bool,
    linkKanban: PropTypes.string,
